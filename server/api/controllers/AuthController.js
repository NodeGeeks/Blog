...
module.exports = {
    ...
    login: function (req, res) {
        ...
        function execute(err, profile) {
            ...
            if (!profile) return res.notFound({message: 'No profile found with that login.', code: 404});
            ...
            bcrypt.compare(req.body.password, profile.password, function (err, match) {
                if (match) {
                    ...
                    return res.forbidden({message: 'Invalid password combination for that login.', code: 403});
                }
            });
        }
    },
